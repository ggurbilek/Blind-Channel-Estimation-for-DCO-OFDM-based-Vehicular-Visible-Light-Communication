...
d0=1;
%theta_0=0.3513;
theta_0_dB = [-17.0262170915871;1.07386323987409;6.23615814622198;7.75007607402166;8.53159834135263;8.98465640352108;9.16640106872739;8.84664112329213;8.22452278829445;4.19154480321457;-3.74357580230714].' +40; % 40dB PD gain
theta_0=db2mag(theta_0_dB);
zenith_angle=50:-10:-50;
v=30; %m/s2
a=0; %m/s2
dt=1/(2*1e6);
...
figure
semilogy(zenith_angle,const*1/2*(1-BBER),'pb-')
hold on
semilogy(zenith_angle,const*2/3*(1-BBBER),'sr-') 
hold on
semilogy(zenith_angle,const*3/4*(1-BBBBER),'dy-')
hold on
semilogy(zenith_angle,const*1/2*(1-CBER),'+k-')
hold on
semilogy(zenith_angle,const*2/3*(1-CCBER),'xc-')
hold on
semilogy(zenith_angle,const*3/4*(1-CCCBER),'*m-')
hold on
semilogy(zenith_angle,const*(1-SBER),'ob-')
hold on
semilogy(zenith_angle,const*(1-BER),'^g-')
...
title('Parking Structure at 10m')
grid on
